...
const TransactionHistory = () => {
  ...
  const handleApprove = async (transaction_id) => {
    Swal.fire({
      ...
      customClass: {
        popup:
          "bg-gray-800 text-white rounded-lg shadow-lg w-[90%] sm:w-[400px]", // Popup styling
      ...
      if (result.isConfirmed) {
        ...
        try {
          ...
          Swal.fire({
            ...
            customClass: {
              popup:
                "bg-gray-800 text-white rounded-lg shadow-lg w-[90%] sm:w-[400px]",
    ...
    <div className="bg-white flex justify-center min-h-screen font-Inter overflow-hidden">
      {loading ? (
        ...
        <div className="bg-black text-white w-full max-w-lg flex flex-col px-4 overflow-hidden">
          ...
          <div
            id="no-drag"
            className="flex items-center bg-[#1C1C1E] justify-between rounded-xl hide-scrollbar overflow-y-auto"
          >
            <button
          ...
          <div
            className="flex-grow py-4 h-[400px] overflow-y-auto hide-scrollbar"
                        ...
                        >
                          <div className="flex items-center space-x-3">
                            ...
                            <span className="flex flex-col">
                              <h3 className="text-sm font-semibold capitalize">
                                {transaction.title == "Coins Transferred"
                                  ? "Transfer"
                                  : transaction.title}
                              </h3>
                              {transaction.type == "transfer" && (
                                <p className="text-xs">
                                  Receiver: {transaction.user_name}
                                </p>
                              )}
                            </span>
                          </div>
                          <p className="text-sm font-medium">
                            {transaction.pending_coin === 0
                              ? `${transaction.earn_coin > 0 ? "" : ""}${
                                  transaction.earn_coin
                                } Coins`
                    ...
                    <div key={date}>
                      {Object.keys(groupedWithdrawals).map((date) => (
                        <div key={date} className="mb-6">
                          ...
                          {groupedWithdrawals[date].map(
                            (transaction, index) => (
                              <div
                                key={index}
                                className={`flex items-center justify-between mx-2 py-3 ${
                                  activeDiv === index
                                ...
                                onClick={() =>
                                  handleDivClick(index, transaction)
                                } // Trigger click event
                              >
                                <div className="flex items-center space-x-3">
                                  <img
                                ...
                                <button
                                  onClick={() =>
                                    handleApprove(transaction.transaction_id)
                                  }
                            ...
                            <table className="w-full table-auto text-white text-sm md:text-base border-collapse">
                              <tbody>
                                ...
                                <tr className="hover:bg-gray-700 transition duration-200 rounded-md">
                                  ...
                                  <td className="py-2 px-4 border-b border-gray-700 break-all">
                                ...
                                <tr className="hover:bg-gray-700 transition duration-200 rounded-md">
                                  ...
                                  <td className="py-2 px-4 border-b border-gray-700 break-all">
                                    {transaction && transaction.utr_no
                                      ? transaction.utr_no
                                      : "Waiting"}
                                  </td>
                                </tr>
